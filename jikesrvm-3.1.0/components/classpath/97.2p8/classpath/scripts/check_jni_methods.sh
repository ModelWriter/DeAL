...
grep -h '^JNIEXPORT .* Java_' /home/ferhat/DeAL/jikesrvm-3.1.0/components/classpath/97.2p8/classpath/include/*.h | \
...
find /home/ferhat/DeAL/jikesrvm-3.1.0/components/classpath/97.2p8/classpath/native/jni -name \*.c | \
	xargs grep -h '^Java_' | \
...
find /home/ferhat/DeAL/jikesrvm-3.1.0/components/classpath/97.2p8/classpath/native/jni -name \*.cpp | \
	xargs grep -h '^Java_' | \
        LC_ALL=C sed -e 's,^\(Java_[a-z_A-Z0-9]*\).*$,\1,' >> $TMPFILE2
find /home/ferhat/DeAL/jikesrvm-3.1.0/components/classpath/97.2p8/classpath/native/jni -name \*.cpp | \
